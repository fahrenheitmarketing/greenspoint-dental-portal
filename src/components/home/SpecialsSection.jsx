...
const specials = [
  {
    ...
    description: 'Comprehensive exam, full X-rays, and professional cleaning. Everything you need to start your dental journey with confidence.',
    price: '$99',
    note: 'No hidden costs',
  },
  {
    title: 'Dental Exam & X-Rays',
    description: 'Quick checkup to see where you stand. Perfect if you haven\'t been to a dentist in a while and want to know your options.',
    price: '$39',
    note: 'No surprises',
  },
  {
    title: 'Free Consultation',
    description: 'Thinking about braces, implants, or a smile makeover? Come in for a free consultation and we\'ll walk you through your options and costs.',
    price: 'FREE',
    note: 'No obligation',
  },
];
