      ...
      <section className="bg-gradient-to-br from-primary/5 via-background to-secondary/5 py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl">
            <p className="text-secondary font-medium text-sm uppercase tracking-wider mb-3">Contact Us</p>
            ...
            <p className="text-lg text-muted-foreground">
              ...
              Our bilingual team is ready to help — in English or Spanish.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="font-heading text-2xl text-foreground mb-6">Book Your Appointment</h2>
              {submitted ? (
                <div className="p-10 rounded-2xl bg-primary/5 border border-primary/20 text-center">
                  ...
                  <p className="text-muted-foreground">
                    We've received your message and will call you within one business day to confirm your appointment. 
